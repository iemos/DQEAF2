...
def main():
    ...
    class EpsPolicy(EpsGreedyQPolicy):
        def __init__(self, start_epsilon, final_epsilon, steps):
            super(EpsPolicy, self).__init__()
        ...
        def select_action(self, q_values):
            ...
            self.eps -= (self.start_epsilon - self.final_epsilon) / self.steps
            return action
    ...
    def train_keras_dqn_model(args):
        ...
        policy = EpsPolicy(args.start_epsilon, args.end_epsilon, args.steps)
